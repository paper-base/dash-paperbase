      ...
      <ZoneBlock zone="top" activeZones={activeZones} label="Home Top — Navbar / Hero">
        <div className="space-y-3 p-4 pt-8">
          ...
          <div className="flex flex-col items-center gap-2 py-6">
            ...
            <div className="mt-2 h-7 w-24 rounded-md bg-muted/50" />
          </div>
        </div>
      </ZoneBlock>
        ...
        <div className="grid grid-cols-3 gap-3 p-4 pt-8">
          ...
          <div className="col-span-2 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="h-20 rounded-md bg-muted/30" />
              <div className="h-20 rounded-md bg-muted/30" />
            </div>
            <div className="space-y-1.5">
              <div className="h-2.5 w-3/4 rounded bg-muted/40" />
              <div className="h-2.5 w-1/2 rounded bg-muted/35" />
            </div>
          </div>
          {/* Sidebar */}
      ...
      <ZoneBlock zone="bottom" activeZones={activeZones} label="Home Bottom — Footer">
        <div className="space-y-3 p-4 pt-8">
          ...
          <div className="flex gap-6">
            <div className="space-y-1.5">
              <div className="h-2 w-14 rounded bg-muted/35" />
